...
/**
 * This is the item provider adapter for a {@link architecture.Port} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void addDependencePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Port_dependence_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Port_dependence_feature", "_UI_Port_type"),
				 ArchitecturePackage.Literals.PORT__DEPENDENCE,
				 true,
				 false,
				 true,
				 null,
