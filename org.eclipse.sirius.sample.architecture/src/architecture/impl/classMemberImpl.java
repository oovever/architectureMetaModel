 ...
 * </p>
 * <ul>
 *   <li>{@link architecture.impl.classMemberImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class classMemberImpl extends MinimalEObjectImpl.Container implements classMember {
	...
	protected EClass eStaticClass() {
		return ArchitecturePackage.Literals.CLASS_MEMBER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ArchitecturePackage.CLASS_MEMBER__NAME, oldName, name));
	}
